...
class Catering_EventAdmin(ImportExportMixin,admin.ModelAdmin):
    list_display = ('title', 'category',   'price', 'currency', 'is_mobile', 'region', 'negotiable', 'sponsored', 'featured', 'created_at', 'updated_at')
    list_filter = ('category',   'region', 'sponsored', 'featured')
