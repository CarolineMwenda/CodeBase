...
class GamingAdmin(ImportExportMixin,admin.ModelAdmin):
    list_display = ('title', 'category',  'color', 'size', 'brand', 'material', 'model', 'year', 'condition', 'platform', 'genre', 'multiplayer', 'developer', 'publisher', 'sponsored', 'featured', 'new', 'most_sold', 'out_of_stock', 'price', 'quantity', 'region', 'negotiable', 'owner',)
