...
class GroceryAdmin(ImportExportMixin,admin.ModelAdmin):
    list_display = ('title', 'price', 'quantity', 'region', 'negotiable', 'sponsored', 'featured', 'new', 'most_sold', 'out_of_stock', 'product_serial', 'owner', 'updated', 'created')
    list_filter = ('category',  'color',   'condition', 'sponsored', 'featured', 'new', 'most_sold', 'out_of_stock', 'negotiable', )
    search_fields = ('title', 'region', 'owner__name')
    list_per_page = 25
    ordering = ['-created']
